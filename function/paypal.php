<?php
	...
	if (isset($_POST['pay_now'])){
		...
		$t_id = $r_id;
		$date = date("M d, Y");
		$que = mysqli_query($conn, "INSERT INTO `transaction` (transaction_id, customerid, amount, order_stat, order_date) VALUES ('$t_id', '$cid', '$total', 'Đang giao hàng', '$date')") or die (mysqli_error());				
