...
<body>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr/>
							<tr>
								<td><input type="text" name="product_price" placeholder="Giá cả" style="width:250px;" required></td>
							</tr>
							<tr>
								<td><input type="text" name="product_size" placeholder="Size" style="width:250px;" maxLength="2" required></td>
							</tr>
							<tr>
								<td><input type="text" name="brand" placeholder="Nhà sản xuất" style="width:250px;" required></td>
							</tr>
							<tr>
								<td><input type="number" name="qty" placeholder="Số lượng tồn kho" style="width:250px;" required></td>
							</tr>
							<tr>
								<td><input type="hidden" name="category" value="Firewall"></td>
							</tr>
						</table>
					</center>
				</div>
	...
	<div id="rightcontent" style="position:absolute; top:10%;">
			<div class="alert alert-info"><center><h2>Firewall 🟫🔥</h2></center></div>
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="Tìm kiếm sản phẩm tại đây 🔎" id="filter"></label>
			<br />
			...
			<table class="table table-hover" style="background-color:;">
				...
				<?php
					...
					$query = mysqli_query($conn, "SELECT * FROM `product` WHERE category='Firewall' ORDER BY product_id DESC") or die(mysqli_error());
				...
				<tr class="del<?php echo $id?>">
					...
					<td><?php echo $fetch['product_price']?> Triệu</td>
					...
					<td>
					<?php
					echo "<a href='stockin.php?id=".$id."' class='btn btn-success' rel='facebox'><i class='icon-plus-sign icon-white'></i> Thêm hàng</a> ";
					echo "<a href='stockout.php?id=".$id."' class='btn btn-danger' rel='facebox'><i class='icon-minus-sign icon-white'></i> Bớt hàng</a>";
					?>
					</td>
				</tr>		
				<?php
