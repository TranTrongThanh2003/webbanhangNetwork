...
<head>
	...
	<script src="js/signin-test.js"></script>
</head>
...
<input type="number" name="mobile" placeholder="ĐT cá nhân" maxlength="11" required value="<?php echo isset($_POST['mobile']) ? htmlspecialchars($_POST['mobile']) : ''; ?>">
<input type="number" name="telephone" placeholder="ĐT khác (nếu có)" maxlength="10" value="<?php echo isset($_POST['telephone']) ? htmlspecialchars($_POST['telephone']) : ''; ?>">
	...
	<div id="container">
		<div id="carousel">
			<div id="myCarousel" class="carousel slide">
				<div class="carousel-inner">
					<div class="active item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner1_cis.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner2_cis.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner3_cis.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner4_cis.jpg" class="carousel"></div>
					<div class="item" style="padding:0; border-bottom:0 solid #111;"><img src="img/banner5_cis.jpg" class="carousel"></div>
				</div>
		...
		<div id="content">
			<div id="product" style="position:relative; margin-top:30%;">
				<center>
					<h2>
						<legend><span style="color:orangered;font-size:25px">📡 DANH MỤC NỔI BẬT 🌐 </span></legend>
					</h2>
				</center>
				<br />
